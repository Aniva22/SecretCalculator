...
1. Klon repositori:
   ```bash
   git clone https://github.com/username/SecretCalculator.git
   ```
2. Buka proyek di Android Studio.
3. Sinkronkan proyek dengan Gradle (**File > Sync Project with Gradle Files**).
4. Tambahkan file sumber daya (`sample_audio.mp3`, `sample_image.jpg`, ikon kalkulator) ke direktori yang sesuai.
5. Jalankan aplikasi di perangkat fisik atau emulator dengan Google Play Services.
6. Uji fitur:
